...
const App = () => {
  ...
  const switchNetwork = async () => {
    if (window.ethereum) {
              ...
              params: [
                {
                  ...
                  rpcUrls: ['https://polygon-mumbai.g.alchemy.com/v2/uwkozWct944vIJsJs5MZ0rJrlfNwKPc0'],
                  nativeCurrency: {
                    name: "Mumbai Matic",
                    symbol: "MATIC",
                    decimals: 18
      ...
      alert ('Metamask not installed. Please install it to use app:  https://metamask.io/download.html')
    }
  }
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img src="https://media.giphy.com/media/VT3zPktC9eO52kuuw4/giphy.gif" alt="Ninja donut gif" />
